...
<html>
    <head>
        <title>Admin AM - Update Cart</title>
        <meta charset="UTF-8">
            ...
            <div class="row justify-content-md-center" style="margin-top:10px; margin-bottom:30px">  
                <form action=" " method="post">
                    <table>
                        <tbody>
                            <tr>
                                <td class="align-middle input-data-padding"><input class="input-data" type="hidden" id="Id_Cart" name="Id_Cart" value="<?= $Fish_Data['Id_Cart']; ?>"></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td colspan="2">
                                    <div class="row justify-content-md-center">
                                        ...
                                        <a href="/admin/cart" style="text-decoration:none"><button class="input-data-button" style="margin-top:20px" type="button">Back to View</button></a>
                                    </div>
                                </td>
                            </tr>
                        </tbody>
