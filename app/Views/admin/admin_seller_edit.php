            ...
            <div class="row justify-content-md-center" style="margin-top:10px; margin-bottom:30px">  
                <form action=" " method="post">
                    <table>
                        <tbody>
                            <tr>
                                <td class="align-middle input-data-padding"><input class="input-data" type="hidden" id="Id_Seller" name="Id_Seller" value="<?= $Fish_Data['Id_Seller']; ?>"></td>
                            </tr>
                            <tr>
                                <td class="align-middle input-data-padding"><p>Id_Seller</p></td>
                                <td class="align-middle input-data-padding"><input class="input-data" type="text" id="input-Id_Seller" name="Id_Seller" value=""></td>
                            </tr>
                            <tr>
                                <td class="align-middle input-data-padding"><p>Name_Seller</p></td>
                                <td class="align-middle input-data-padding"><input class="input-data" type="text" id="input-Name_Seller" name="Name_Seller" value=""></td>
                            </tr>
                            <tr>
                                <td colspan="2">
                                    <div class="row justify-content-md-center">
