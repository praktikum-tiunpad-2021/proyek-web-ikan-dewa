...
<html>
    <head>
        <title>Admin AM - Update postCode</title>
        <meta charset="UTF-8">
            ...
            <div class="row justify-content-md-center" style="margin-top:10px; margin-bottom:30px">  
                <form action=" " method="post">
                    <table>
                        <tbody>
                            <tr>
                                <td class="align-middle input-data-padding"><input class="input-data" type="hidden" id="Id_Post_Code" name="Id_Post_Code" value="<?= $Fish_Data['Id_Post_Code']; ?>"></td>
                            </tr>
                            <tr>
