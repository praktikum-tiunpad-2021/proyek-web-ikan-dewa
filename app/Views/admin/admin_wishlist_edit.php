...
<html>
    <head>
        <title>Admin AM - Update Wishlist</title>
        <meta charset="UTF-8">
            ...
            <div class="row justify-content-md-center" style="margin-top:10px; margin-bottom:30px">  
                <form action=" " method="post">
                    <table>
                        <tbody>
                            <tr>
                                <td class="align-middle input-data-padding"><input class="input-data" type="hidden" id="Id_Wishlist" name="Id_Wishlist" value="<?= $Fish_Data['Id_Wishlist']; ?>"></td>
                            </tr>
                            <tr>
