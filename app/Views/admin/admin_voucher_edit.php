                    ...
                    <table>
                        <tbody>
                            <tr>
                                ...
                                <td class="align-middle input-data-padding"><input class="input-data" type="text" id="Id_Voucher" name="Id_Voucher" value="<?= $DataVoucher[0]['Id_Voucher']; ?>" readonly></td>
                            </tr>
                            <tr>
                                <td class="align-middle input-data-padding"><p>Code_Voucher</p></td>
                                <td class="align-middle input-data-padding"><input class="input-data" type="text" id="input-Code_Voucher" name="Code_Voucher" value="<?= $DataVoucher[0]['Code_Voucher']; ?>" required></td>
                            </tr>
                            <tr>
                                <td class="align-middle input-data-padding"><p>Price_Discount</p></td>
                                <td class="align-middle input-data-padding"><input class="input-data" type="text" id="input-Price_Discount" name="Price_Discount" value="<?= $DataVoucher[0]['Price_Discount']; ?>" required></td>
                            </tr>
                            <tr>
                                <td colspan="2">
                                    <div class="row justify-content-md-center">
